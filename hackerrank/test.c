 ...
 *
 */
SinglyLinkedListNode* create(int d)
{
...
SinglyLinkedListNode *h3=NULL,*t,*temp;
while(head1!=NULL||head2!=NULL)
{
  if((head1!=NULL&&head1->data<=head2->data)||head2==NULL)
  {
      temp=create(head1->data);
      head1=head1->next;
  }
  else
  {
      temp=create(head2->data);
      head2=head2->next;
  }
  if(h3==NULL)
  {
